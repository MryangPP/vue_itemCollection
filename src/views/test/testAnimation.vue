        ...
        <div class="header-v4">
          <div class="ho-middle-wrap">
            <div class="header-nav-v4 ho-middle-v4">
              <div class="logo-home">
                <img src="@/assets/images/honor-logo-black.svg" class="logo" alt="" />
              </div>
              <div class="pc-header">
                <div class="nav-lists">
                  <div class="nav-item">
    ...
    <div class="content">
      <div class="main magic-os">
        ...
        <section class="section-hero section-dark section-row" id="section-hero">
          <div class="section-wrapper aspect-ratio">
            <div class="banner-img_box">
              <img src="@/assets/images/kv.png" class="banner-img" alt="" />
            </div>
            <div class="section-magic-os">
              <img src="@/assets/images/magic-os-light.svg" class="section-name" alt="" />
                ...
                <div class="section-card">
                  <div class="section-card-content section-rounded">
                    ...
                    <div class="section-media">
                      <img src="@/assets/images/s4-01-poster.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="section-card">
                  <div class="section-card-content section-rounded">
                    ...
                    <div class="section-media">
                      <img src="@/assets/images/s4-02-poster.jpg" alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="section-wrapper">
                <div class="section-card">
                  <div class="section-card-content section-rounded">
                    ...
                    <div class="section-media">
                      <img src="@/assets/images/s6-01-poster.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="section-card">
              ...
              <div class="section-content">
                ...
                <div id="section-s1-p" class="section-picture">
                  <div class="section-picture-1 aspect-ratio">
                    <picture>
                      <img src="@/assets/images/s1-01.png" alt="" />
                    </picture>
                  </div>
                  <div id="section-service-card" class="section-service-card">
                    <div id="section-s1-p2" class="section-card section-picture-2 will-zoomin">
                      <picture>
                        <img src="@/assets/images/s1-02.png" alt="" />
                      </picture>
                    </div>
                    <div id="section-s1-p3" class="section-card section-picture-3 will-zoomin">
                      <picture>
                        <img src="@/assets/images/s1-03.png" alt="" />
                      </picture>
                    </div>
                  </div>
                </div>
        ...
        <section class="section-service-2 section-spacers">
          ...
          <div class="section-card">
            <picture>
              <img src="@/assets/images/s2-card.png" alt="" />
            </picture>
          </div>
        </section>
              ...
              <div class="section-wrapper">
                <div class="section-card">
                  <div class="section-card-content section-rounded">
                    ...
                    <div class="section-media">
                      <img src="@/assets/images/s3-01.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="section-card">
                  <div class="section-card-content section-rounded">
                    ...
                    <div class="section-media">
                      <img src="@/assets/images/s3-02.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="section-card">
                  ...
                  <div class="section-fill-wrapper os-turbo-x">
                    <div class="section-fill-content">
                      ...
                      <img
                        ...
                        src="@/assets/images/os-turbo-x.svg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  <div class="section-improved">
                    <div class="section-improved-item">
                      ...
                      <div class="section-ratio">
                        <img
                          src="@/assets/images/icon-arrow-down-blue.svg"
                          alt=""
                          class="section-icon"
                        />
            ...
            <div class="sticky-content">
                ...
                <div class="section-item section-fill-item">
                  ...
                  <div class="section-fill-wrapper gpu-turbo-x">
                    <div class="section-fill-content">
                      ...
                      <img
                        class="section-headline-picture"
                        src="@/assets/images/gpu-turbo-x.svg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="section-content">
                <div class="section-picture aspect-ratio">
                  <picture>
                    <img class="blur-up lazyload" src="@/assets/images/gpu-turbo-x-01.png" alt="" />
                  </picture>
                </div>
              </div>
            </div>
            ...
            <div class="sticky-content section-row">
                ...
                <div class="section-item section-fill-item">
                  ...
                  <div class="section-fill-wrapper gpu-turbo-x">
                    <div class="section-fill-content">
                      ...
                      <img
                        class="section-headline-picture"
                        src="@/assets/images/link-turbo-x.svg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="section-content section-row">
                <img
                  ...
                  src="@/assets/images/icon-signal-tower-white.svg"
                  alt=""
                />
                <div class="section-col">
                ...
                <img
                  ...
                  src="@/assets/images/icon-signal-tower-blue.svg"
                  alt=""
                />
              </div>
            </div>
                ...
                <div class="section-breath-font section-row">
                  <div class="section-text-wrapper">
                    <div class="section-spilt section-spilt-1">
                      <img class="section-s1" src="@/assets/images/text/1.svg" />
                      <img class="section-s2" src="@/assets/images/text/2.svg" />
                      <img class="section-s3" src="@/assets/images/text/3.svg" />
                      <img class="section-s4" src="@/assets/images/text/4.svg" />
                      <img class="section-s5" src="@/assets/images/text/5.svg" />
                    </div>
                    <div class="section-spilt section-spilt-2">
                      <img class="section-s6" src="@/assets/images/text/6.svg" />
                      <img class="section-s7" src="@/assets/images/text/7.svg" />
                      <img class="section-s8" src="@/assets/images/text/8.svg" />
                      <img class="section-s9" src="@/assets/images/text/9.svg" />
                      <img class="section-s10" src="@/assets/images/text/10.svg" />
                      <img class="section-s11" src="@/assets/images/text/11.svg" />
                      <img class="section-s19" src="@/assets/images/text/19.svg" />
                      <img class="section-s12" src="@/assets/images/text/12.svg" />
                    </div>
                    <div class="section-spilt section-spilt-3">
                      <img class="section-s13" src="@/assets/images/text/13.svg" />
                      <img class="section-s14" src="@/assets/images/text/14.svg" />
                      <img class="section-s15" src="@/assets/images/text/15.svg" />
                    </div>
                    <div class="section-spilt section-spilt-4">
                      <img class="section-s16" src="@/assets/images/text/16.svg" />
                      <img class="section-s17" src="@/assets/images/text/17.svg" />
                      <img class="section-s18" src="@/assets/images/text/18.svg" />
                    </div>
                  </div>
              ...
              <div class="section-has-video">
                <div class="section-video-wrapper aspect-ratio">
                  <video
                    ...
                    x5-video-player-fullscreen
                    x5-video-player-type="h5"
                    src="@/assets/images/design/s3.mp4"
                  ></video>
                </div>
                      ...
                      <div class="section-video-wrapper section-video-wrapper-1 aspect-ratio">
                        <div class="section-inline-video">
                          <video
                            ...
                            x5-video-player-fullscreen
                            x5-video-player-type="h5"
                            src="@/assets/images/design/s4-01.mp4"
                          ></video>
                          <img class="section-static-frame" src="@/assets/images/design/s4-01.jpg" alt="" />
                        </div>
                      </div>
                      ...
                      <div class="section-video-wrapper">
                        <div class="section-inline-video">
                          <video
                            ...
                            x5-video-player-fullscreen
                            x5-video-player-type="h5"
                            src="@/assets/images/design/s4-02-0215.mp4"
                          ></video>
                          <img class="section-static-frame" src="@/assets/images/design/s4-02-0215.jpg" alt="" />
                        </div>
                      </div>
                      <div class="section-button-wrapper align-button">
                        <div class="section-video-button section-replay-all will-fadein">
                      ...
                      <div class="section-video-wrapper">
                        <div class="section-inline-video">
                          <video
                            ...
                            x5-video-player-fullscreen
                            x5-video-player-type="h5"
                            src="@/assets/images/design/s4-03.mp4"
                          ></video>
                          <img class="section-static-frame" src="@/assets/images/design/s4-03.jpg" alt="" />
                        </div>
                      </div>
                      <div class="section-button-wrapper align-button">
                        <div class="section-video-button section-replay-all will-fadein">
                ...
                <div class="section-cards section-cards-1">
                  <div id="section-smart-2-p1" class="section-picture will-transform">
                    <div class="section-card aspect-ratio">
                      <picture>
                        <img
                          ...
                          src="@/assets/images/smart/s2-card-01.png"
                          alt=""
                        />
                      </picture>
                    </div>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-02.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-03.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-04.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-05.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-06.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-07.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-08.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-09.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-10.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-11.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-12.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-13.png"
                        alt=""
                      />
                    </picture>
                    <picture class="section-card">
                      <img
                        class="blur-up lazyload"
                        src="@/assets/images/smart/s2-card-14.png"
                        alt=""
                      />
                    </picture>
                  </div>
...
<script>
export default {
  name: 'Honor' // 定义组件的名称为 "Honor"
}
</script>
<script setup>
// 引入 Vue 的 `ref` 和 `onMounted` 方法，用于响应式数据和生命周期钩子
import { ref, onMounted } from 'vue'

// 引入 GSAP 动画库及其插件 ScrollTrigger，用于实现滚动触发的动画效果
import gsap from 'gsap'
import { ScrollTrigger } from 'gsap/ScrollTrigger'

// 获取屏幕宽度和高度，用于计算动画的布局和位置
const screenWidth = document.documentElement.clientWidth,
  screenHeight = document.documentElement.clientHeight

// 定义固定导航栏的高度，用于计算滚动触发点
const stickyNavHeight = 65

// 标识是否为竖屏模式，默认为 false
const isPortrait = false

// 定义主容器的引用，稍后会在 `onMounted` 中赋值
let MAIN = null

// 定义滚动动画的时间，用于控制动画的平滑程度
const scrubTime = 0.5

// 注册 GSAP 的 ScrollTrigger 插件
gsap.registerPlugin(ScrollTrigger)

// 注册一个自定义动画效果 "tech4"，用于复用动画逻辑
gsap.registerEffect({
  name: 'tech4', // 动画名称
  extendTimeline: true, // 允许将此效果扩展到时间轴
...
// 定义一个函数 `stickyCenter`，用于计算和设置粘性元素的位置
const stickyCenter = (stickyEl, wrapper) => {
  const bodyHeight = wrapper.offsetHeight, // 获取内容的高度
    center = (screenHeight - stickyNavHeight - bodyHeight) / 2, // 计算垂直居中的位置
    top = center > 0 ? center + stickyNavHeight : stickyNavHeight // 如果中心位置大于 0，则加上导航栏高度

  stickyEl.style.top = top + 'px' // 设置粘性元素的顶部位置
  stickyEl.setAttribute('data-top', top) // 将顶部位置存储为自定义属性
}

// 定义一个函数 `heroFn`，用于处理第一屏的动画
const heroFn = () => {
  const sectionHero = document.getElementById('section-hero') // 获取第一屏的 DOM 元素
  gsap.timeline({
    scrollTrigger: {
      trigger: sectionHero, // 触发动画的元素
      toggleClass: 'animated' // 滚动到触发点时添加类名
    }
  })
}

// 定义一个函数 `triggerFn`，用于处理带有 `fade-trigger` 类名的元素的动画
const triggerFn = () => {
  const triggerList = document.querySelectorAll('.fade-trigger') // 获取所有带有 `fade-trigger` 类名的元素
  triggerList.forEach(item => {
    const hook = item.getAttribute('data-hook') || '70%' // 获取触发点，默认为 70%
    console.log(hook, 'hook') // 打印触发点信息
    gsap.timeline({
      scrollTrigger: {
        trigger: item, // 触发动画的元素
        start: 'top ' + hook, // 动画开始的位置
        toggleClass: 'active', // 滚动到触发点时添加类名
        markers: false // 是否显示滚动触发点的标记
      }
    })
  })
}

// 定义一个函数 `groupFn`，用于处理带有 `fade-group` 类名的元素的动画
const groupFn = () => {
  const groupList = document.querySelectorAll('.fade-group') // 获取所有带有 `fade-group` 类名的元素
...
// 定义一个函数 `connect5Fn`，用于处理第五屏的动画
const connect5Fn = () => {
  const picture = document.getElementById('section-c5-p') // 获取第五屏的图片元素
  gsap.timeline({
    scrollTrigger: {
      trigger: picture, // 触发动画的元素
      toggleClass: 'animated' // 滚动到触发点时添加类名
    }
  })
}
...
onMounted(() => {
  MAIN = document.querySelector('.honor') // 获取主容器的 DOM 元素
